About morepath-feedstock
========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/morepath-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/morepath/morepath

Documentation: http://morepath.readthedocs.io/
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3132&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/morepath-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `morepath` can be installed with `conda`:
...
```
mamba install morepath
```

It is possible to list all of the versions of `morepath` available on your platform with `conda`:
...
```
mamba search morepath --channel conda-forge
```
...
mamba repoquery search morepath --channel conda-forge

# List packages depending on `morepath`:
mamba repoquery whoneeds morepath --channel conda-forge

# List dependencies of `morepath`:
mamba repoquery depends morepath --channel conda-forge
```
